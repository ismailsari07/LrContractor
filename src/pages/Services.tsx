...
export const Services = ({}: ServicesProps) => {
	return (
		<>
			<Helmet>
				<title>Services | Renovation Services Toronto | LR Contractor</title>
				<meta
					name="description"
					content="Explore all renovation services offered by LR Contractor in Toronto. From drywall and painting to demolition and flooring, we deliver quality results."
				/>
				<meta
					name="keywords"
					content="services, renovation, Toronto, drywall, painting, demolition, flooring, contractor, home improvement"
				/>
				<meta
					property="og:title"
					content="Services | Renovation Services Toronto | LR Contractor"
				/>
				<meta
				...
				<meta property="og:url" content="https://www.lrcontractor.ca/services" />
				...
				<meta
					...
					content="Explore all renovation services offered by LR Contractor in Toronto. From drywall and painting to demolition and flooring, we deliver quality results."
				/>
				<link rel="canonical" href="https://www.lrcontractor.ca/services" />
			</Helmet>
			<motion.div
