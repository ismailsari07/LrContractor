...
export const Contact = ({}: ContactProps) => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact | Renovation Services Toronto | LR Contractor</title>
        <meta name="description" content="Contact LR Contractor for expert renovation services in Toronto. Get in touch for personalized advice, quotes, and project consultations." />
        <meta name="keywords" content="contact, renovation, Toronto, contractor, consultation, quote, home improvement" />
        <meta property="og:title" content="Contact | Renovation Services Toronto | LR Contractor" />
        <meta property="og:description" content="Contact LR Contractor for expert renovation services in Toronto. Get in touch for personalized advice, quotes, and project consultations." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.lrcontractor.ca/contact" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Contact | Renovation Services Toronto | LR Contractor" />
        <meta name="twitter:description" content="Contact LR Contractor for expert renovation services in Toronto. Get in touch for personalized advice, quotes, and project consultations." />
        <link rel="canonical" href="https://www.lrcontractor.ca/contact" />
      </Helmet>
      <motion.div
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-start justify-center mt-8 lg:mt-0">
            <div className="flex items-center gap-3 mb-4 text-base md:text-lg">
              ...
              <div className="font-semibold text-green-600">
                <a href="tel:+16476809164"> +1 (647) 680-9164 </a>
              </div>
            </div>
            <div className="flex items-center gap-3 mb-4 text-base md:text-lg">
              <span className="inline-block">
              ...
              <a href="mailto:ramazan@lrcontractor.ca">
